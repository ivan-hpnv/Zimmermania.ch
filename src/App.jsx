    ...
    <main id="top">
      ...
      <section className="image-ribbon" aria-label="Atmosphäre im Zimmermania">
        <figure className="ribbon-main">
          <img src="/1 foto.jpg" alt="Blumen und Leuchten im Restaurant Zimmermania" />
        </figure>
        ...
        <figure className="ribbon-side">
          <img src="/2foto.jpg" alt="Historischer Schriftzug Restaurant Zimmermania" />
        </figure>
      </section>
      ...
      <section className="history-section" id="histoire">
        <div className="history-image">
          <img src="/7foto.jpg" alt="Historische Darstellung der Berner Altstadt" />
          <p>Brunngasse · Bern</p>
        </div>
